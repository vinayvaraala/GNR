...
public partial class surgicals_medical : System.Web.UI.Page
{
    ...
    protected void LoadMenuModules()
    {
        ...
        {
            conn.Open();
            string query = "vinay.MEDICALDISPOSABLES";
            ...
            while (dr.Read())
            {
                ...
                sb.Append("<div class=\"col-sm-4 margin30\" style='Height:450px'><div class=\"service-box\"><a href='img/images/large/" + img + "' target='_blank'><img  width='100%' height='200' style='height:200px;' src='img/images/thumbs//" + img + "' alt=\"\"></a>");
                ...
                /* sb.Append("<li class=\"list-group-item\"><div class='row'><div class='col-sm-10'>" + dr[0].ToString() + "</div>");
                 sb.Append("<div class='col-sm-2'><a href='img/images/" + dr[1].ToString() + "' target='_blank'>");
                 sb.Append("<img width='125' height='125' class='img-thumbnail' src='img/images/" + dr[1].ToString() + "' /></a><br /> <button class='btn btn-success' style='margin-left:15px;margin-top:5px;' type='button' onclick='PopulateValue(\"" + dr[0].ToString() + "\");'>Get Quote</button></div></div></li>");
                 * */
